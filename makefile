a: main.cpp tech_func.cpp parsing.cpp tokenise.cpp print_tree.cpp;
...
-Wstack-usage=8192 -pie -fPIE -Werror=vla  main.cpp tech_func.cpp parsing.cpp tokenise.cpp print_tree.cpp -o diff.out