front: Frontend/main.cpp tech_func.cpp Frontend/parsing.cpp Frontend/tokenise.cpp Frontend/print_tree.cpp;
	g++ -IMath_funcs -IFrontend -I. -D _DEBUG -ggdb3 -std=c++17 -O0 -Wall -Wextra -Weffc++ \
...
-Wstack-usage=8192 -pie -fPIE -Werror=vla  Frontend/main.cpp tech_func.cpp Frontend/parsing.cpp Frontend/tokenise.cpp Frontend/print_tree.cpp -o front.out