front: Front_end/main.cpp tech_func.cpp Front_end/parsing.cpp Front_end/tokenise.cpp Front_end/semantika.cpp Front_end/print_tree.cpp;
...
-Wstack-usage=8192 -pie -fPIE -Werror=vla  Front_end/main.cpp tech_func.cpp Front_end/parsing.cpp Front_end/tokenise.cpp \
Front_end/semantika.cpp Front_end/print_tree.cpp -o front.out
